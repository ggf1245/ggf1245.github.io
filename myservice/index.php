...
<script type="text/javascript" src="./js/zindex.js?ver=1"></script>
<script type="text/javascript" src="./js/zvalueCheck.js"></script>
</head>
<body>
  <div id="viewType">
    ...
    <div id="loginForm">
      <form name="loginForm" method="post" action="./login.php">
        ...
        <div id="loginPwArea">
          ...
          <div class="loginInputBox">
            <input type="password" name="userPw" id="loginPw" placeholder="비밀번호 8자리 이상 입력"/>
          </div>
        </div>
